...
Mathnasium, LLC (2019 - 2021)
  ...
  * Managed learning center operations on weekends:
    * Administered assessments to onboard new students 
    * Managed student learning plans to track progress 
    * Followed up with leads to convert enrollments 
    * Scheduled and matched instructors with students to maintain coverage 
